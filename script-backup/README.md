...
|--------|------------|-------------|
| `--preset=lamp` | Apache + MySQL + PHP 8.4 + Composer + Git | Classic LAMP stack (shows confirmation) |
| `--preset=lemp` | Nginx + MySQL + PHP 8.4 + Composer + Git | Modern LEMP stack (shows confirmation) |
| `--preset=minimal` | Apache only | Lightweight web server (shows confirmation) |
| `--preset=full` | Nginx + MySQL + PostgreSQL + PHP 8.3,8.4 + Composer + Node.js + Git + Claude | Complete development environment (shows confirmation) |
